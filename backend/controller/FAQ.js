...
const getActiveFAQs = async (req, res) => {
  try {
    ...
    const count = await FAQ.countDocuments({ status: 'active' });

    // Find FAQs where status is 'active'
...
module.exports = { insertFAQ, getFAQ, updateFAQ, deleteFAQ, getFAQById, countFaq,getActiveFAQs }; 