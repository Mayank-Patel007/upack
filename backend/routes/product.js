...
router.post('/insertSubCategory', requireAuth, uploadLogo,processImage, insertSubCategory)
...
router.put('/updateSubCategory', requireAuth, uploadLogo,processImage, updateSubCategory)
...
router.get('/getcategoriesonly', getCategoriesOnly)
